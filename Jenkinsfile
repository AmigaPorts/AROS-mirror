...
node('master') {
	...
	parallel (
		...
		'Build Vampire version - GCC 6.5.0 - Binutils 2.32': {
			node {
				buildStep('amiga-m68k', 'GorillaSmall', '2.32', '6.5.0', true, 'contrib-installerlg contrib-aminet contrib-networking ports', '--with-aros-prefs=classic ', '-vampire') // --with-cpu=68040 // Disable 040 for Vampire build for now
			}
		},
